...
export function generateAdvisorInsights(input: {
  ...
  if (input.netWorth >= 0) insights.push({ title: "Patrimônio acompanhado", description: "Continue registrando transações para tornar as projeções mais precisas.", tone: "neutral" });
